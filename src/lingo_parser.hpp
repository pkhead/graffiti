...
namespace lingo_ast {
    ...
    struct ast_global_declaration : public ast_statement {
        inline ast_global_declaration() { type = STATEMENT_DECLARE_GLOBAL; }
        std::vector<std::string> identifiers;
    };

    struct ast_property_declaration : public ast_statement {
        inline ast_property_declaration() { type = STATEMENT_DECLARE_PROPERTY; }
        std::vector<std::string> identifiers;
    };
    ...
    struct ast_statement_repeat_while : public ast_statement {
        inline ast_statement_repeat_while() { type = STATEMENT_REPEAT_WHILE; }
